...
################################################################################
## Form generated from reading UI file 'vtn_principal_cargar.ui'
##
...
class Ui_vtn_principal_cargar(object):
    def setupUi(self, vtn_principal_cargar):
        if not vtn_principal_cargar.objectName():
            vtn_principal_cargar.setObjectName(u"vtn_principal_cargar")
        vtn_principal_cargar.resize(694, 411)
        self.centralwidget = QWidget(vtn_principal_cargar)
        ...
        vtn_principal_cargar.setCentralWidget(self.centralwidget)
        self.mnb_menu = QMenuBar(vtn_principal_cargar)
        self.mnb_menu.setObjectName(u"mnb_menu")
        self.mnb_menu.setGeometry(QRect(0, 0, 694, 21))
        vtn_principal_cargar.setMenuBar(self.mnb_menu)
        self.stb_estado = QStatusBar(vtn_principal_cargar)
        self.stb_estado.setObjectName(u"stb_estado")
        vtn_principal_cargar.setStatusBar(self.stb_estado)

        self.retranslateUi(vtn_principal_cargar)

        QMetaObject.connectSlotsByName(vtn_principal_cargar)
    # setupUi

    def retranslateUi(self, vtn_principal_cargar):
        vtn_principal_cargar.setWindowTitle(QCoreApplication.translate("vtn_principal_cargar", u"Bienvenidos a Persona Cargar", None))
        ___qtablewidgetitem = self.tb_personas.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("vtn_principal_cargar", u"ID", None));
        ___qtablewidgetitem1 = self.tb_personas.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("vtn_principal_cargar", u"Nombre", None));
        ___qtablewidgetitem2 = self.tb_personas.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("vtn_principal_cargar", u"Apellido", None));
        ___qtablewidgetitem3 = self.tb_personas.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("vtn_principal_cargar", u"Cedula", None));
        ___qtablewidgetitem4 = self.tb_personas.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("vtn_principal_cargar", u"Email", None));
        ___qtablewidgetitem5 = self.tb_personas.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("vtn_principal_cargar", u"Sexo", None));
        self.btn_actualizar.setText(QCoreApplication.translate("vtn_principal_cargar", u"Actualizar", None))
        self.btn_refrescar.setText(QCoreApplication.translate("vtn_principal_cargar", u"Refrescar", None))
        self.btn_nuevo.setText(QCoreApplication.translate("vtn_principal_cargar", u"Nueva Persona", None))
        self.btn_eliminar.setText(QCoreApplication.translate("vtn_principal_cargar", u"Eliminar", None))
    # retranslateUi
