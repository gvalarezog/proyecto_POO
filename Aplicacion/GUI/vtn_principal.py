...
class Ui_vtn_principal(object):
    def setupUi(self, vtn_principal):
        ...
        self.mnb_menu_principal.setGeometry(QRect(0, 0, 500, 21))
    ...
    def retranslateUi(self, vtn_principal):
        ...
        self.btn_guardar.setText(QCoreApplication.translate("vtn_principal", u"Insertar", None))
        ...
        self.btn_consultar.setText(QCoreApplication.translate("vtn_principal", u"Consultar", None))
